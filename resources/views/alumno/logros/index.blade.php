                        ...
                        <div class="grid md:grid-cols-2 sm:grid-cols-1  mx-auto px-5 py-2">
                            ...
                            @foreach ($logros as $logro)
                                    ...
                                    <div class="text-center border border-gray-300 p-2 m-2 rounded-lg">
                                        ...
                                        <button type="submit"
                                            class="mt-4 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Desbloquear</button>
                                        {!! Form::close() !!}
                                    </div>
